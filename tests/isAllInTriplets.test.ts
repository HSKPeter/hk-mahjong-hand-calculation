import isAllInTriplets from "../package/calculateFaan/isAllInTriplets";
...
test("Classify a valid AllInTriplets Hand", () => {
    ...
    expect(isAllInTriplets(winningHand)).toBe(true);
});
...
test("Classify a Hand which is not AllInTriplets", () => {
    ...
    const chow1 = new Mahjong.Tile({suit: "bamboo", value: 1});
    const chow2 = new Mahjong.Tile({suit: "bamboo", value: 2});
    const chow3 = new Mahjong.Tile({suit: "bamboo", value: 3});
    

    const meld1 = new Mahjong.Meld([chow1, chow2, chow3]);
    const meld2 = new Mahjong.Meld([tile2, tile2, tile2]);
    const meld3 = new Mahjong.Meld([tile3, tile3, tile3]);
    const meld4 = new Mahjong.Meld([tile4, tile4, tile4]);
    const meld5 = new Mahjong.Meld([tile1, tile1]);

    const winningHand = new Mahjong.WinningHand([meld1, meld2, meld3, meld4, meld5]);
    expect(isAllInTriplets(winningHand)).toBe(false);
});