import isGreatWinds from "../package/calculateFaan/isGreatWinds";
...
test("Classify a valid GreatWinds Hand", () => {
    ...
    expect(isGreatWinds(winningHand)).toBe(true);
});
...
test("Classify a Hand which is not GreatWinds", () => {
    ...
    const tile2 = new Mahjong.Tile({suit: "honor", value: 2});
    const tile3 = new Mahjong.Tile({suit: "honor", value: 3});
    const tile4 = new Mahjong.Tile({suit: "honor", value: 5});
    const tile5 = new Mahjong.Tile({suit: "bamboo", value: 8});
    ...
    const winningHand = new Mahjong.WinningHand([meld1, meld2, meld3, meld4, meld5]);
    expect(isGreatWinds(winningHand)).toBe(false);
});
...
test("Classify a Hand which is not GreatWinds (but SmallWinds)", () => {
    ...
    const tile2 = new Mahjong.Tile({suit: "honor", value: 2});
    const tile3 = new Mahjong.Tile({suit: "honor", value: 3});
    const tile4 = new Mahjong.Tile({suit: "dot", value: 5});
